...
namespace Acb.Plugin.PrivilegeManage.Constract.Models.Dtos.User
{
    ...
    public class UserInfoDto
    {
        ...
        /// 用户权限Code列表
        /// </summary>
        public IList<string> PrivilegesCode { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public IList<string> RolesCode { get; set; }
        ...
        /// 
        /// </summary>
        public IList<JsonItem> JsonItems { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public IList<SystemJsonItem> SystemJsonItems { get; set; }
